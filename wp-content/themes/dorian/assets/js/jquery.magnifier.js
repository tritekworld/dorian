jQuery.fn.magnifier=function(o) {
 ...
 n.each(function() {
  ...
  k.wrap('<span class="mgnfr-wrapper" style="position:relative;display:inline-block;overflow:hidden;"></span>');
  w=k.parent();
  w.data('o', o);
  w.append('<div class="mgnfr-region" style="display:none;height:'+o.region.h+'px;width:'+o.region.w+'px;background-color:rgba(128, 128, 128, .5);outline:1px solid rgb(200, 200, 200);position:absolute;z-index:3;"></div>');
